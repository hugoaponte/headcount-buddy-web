...
A player who says Yes after the early nudges won't keep getting "please RSVP" messages — they'll only receive the 48-hour heads-up. The reminder each player receives is tailored to where they stand:
...
- **Automatic reminders** go out on a schedule — roughly a week out, a few days out, and around 48 hours before — for a scheduled event, with no action needed from you.
