...
A short orientation to what the assistant does, then a list linking every topic.

## 1. [START, STOP, and INFO](basic-flows.md)

The text keywords every teammate can use — START to opt in, STOP to opt out, INFO/HELP for a quick reminder.

## 2. [Getting help](help.md)

How to get unstuck — ask the assistant a question, share feedback, or reach a human.

## 3. [What we support: definitions and scope](scope.md)

A plain-English glossary of the building blocks — sports, group and event types, play formats, RSVP states, and organizer roles.

## 4. [About: cost, access, and who builds Headcount Buddy](about.md)

The basics people ask — who builds Headcount Buddy, how to get access, and what it costs.

## 5. [Getting your team or group on board](teams.md)

How to get your team or group on board while we're in limited alpha, and the sports and group types we support.

## 6. [Create your team by text](create-a-team.md)

How an approved organizer sets up their own team over SMS — what to have ready, and what happens next.
